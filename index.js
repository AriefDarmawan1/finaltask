...
async function addBlog(req, res) {
  const { title, content, date, skills } = req.body;
...
async function editBlog(req, res) {
  ...
  if (req.file) {
    const newImagePath = req.file.filename; // Dapatkan nama file gambar baru
    ...
    // Update kolom gambar di database dengan gambar baru
